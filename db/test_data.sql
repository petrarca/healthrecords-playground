...
-- Generated at: 2025-02-27T10:22:34.995Z
...
INSERT INTO patients (
        ...
        blood_type, height, weight, primary_physician,
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4711', 'John', 'Anderson', '1988-07-22', 'male', 'B-', '175[cm]', '80[kg]', 'Dr. Wilson', 'United Health', 'UH789012345', NULL, '(415) 555-0127', 'john.anderson@email.com', ARRAY['Asthma']::varchar[], ARRAY['Sulfa']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4712', 'Robert', 'Anderson', '1971-08-30', 'male', 'A+', '', '', 'Dr. White', 'Anthem', 'AN159753468', NULL, '(415) 555-0131', 'robert.anderson@email.com', ARRAY['GERD', 'Sleep Apnea']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4713', 'Michael', 'Bennett', '1975-03-15', 'male', 'B-', '176[cm]', '78[kg]', 'Dr. Nelson', 'United Health', 'UH901234567', NULL, '(415) 555-0135', 'michael.bennett@email.com', ARRAY['Chronic Back Pain']::varchar[], ARRAY['Aspirin']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4714', 'Sarah', 'Brown', '1995-04-18', 'female', 'AB+', '', '', 'Dr. Thompson', 'United Healthcare', 'UH789123456', NULL, '(415) 555-0126', 'sarah.brown@email.com', ARRAY['Asthma']::varchar[], ARRAY['Dust Mites']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4715', 'Susan', 'Clark', '1982-03-25', 'female', 'B-', '', '', 'Dr. Wilson', 'Cigna', 'CG357951846', NULL, '(415) 555-0138', 'susan.clark@email.com', ARRAY['Endometriosis']::varchar[], ARRAY['Aspirin']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4716', 'Lisa', 'Coleman', '1988-07-22', 'female', 'O+', '167[cm]', '61[kg]', 'Dr. Murphy', 'Kaiser', 'KP012345678', NULL, '(415) 555-0136', 'lisa.coleman@email.com', ARRAY['Eczema']::varchar[], ARRAY['Bee Stings']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4717', 'William', 'Cooper', '1962-11-30', 'male', 'B+', '178[cm]', '82[kg]', 'Dr. Taylor', 'Anthem', 'AN567890123', NULL, '(415) 555-0131', 'william.cooper@email.com', ARRAY['GERD']::varchar[], ARRAY['Ibuprofen']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4718', 'Lisa', 'Foster', '1988-07-22', 'female', 'A-', '170[cm]', '65[kg]', 'Dr. Garcia', 'Humana', 'HU345678901', NULL, '(415) 555-0130', 'lisa.foster@email.com', ARRAY['Anxiety']::varchar[], ARRAY['Dust']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4719', 'Lisa', 'Garcia', '1992-12-10', 'female', 'A-', '', '', 'Dr. Wilson', 'Cigna', 'CG852963741', NULL, '(415) 555-0128', 'lisa.garcia@email.com', ARRAY['Migraine', 'Anxiety']::varchar[], ARRAY['Shellfish']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4720', 'Thomas', 'Harris', '1976-12-08', 'male', 'AB+', '', '', 'Dr. Thompson', 'Blue Cross', 'BC951357846', NULL, '(415) 555-0137', 'thomas.harris@email.com', ARRAY['Psoriasis', 'Anxiety']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4721', 'Emma', 'Hayes', '1962-11-30', 'female', 'AB-', '172[cm]', '67[kg]', 'Dr. Adams', 'Aetna', 'AE890123456', NULL, '(415) 555-0134', 'emma.hayes@email.com', ARRAY['Osteoporosis']::varchar[], ARRAY['Dairy']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4722', 'Richard', 'Jackson', '1959-01-20', 'male', 'A+', '', '', 'Dr. Martinez', 'Humana', 'HU456123789', NULL, '(415) 555-0135', 'richard.jackson@email.com', ARRAY['Chronic Kidney Disease', 'Hypertension']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4723', 'Emma', 'Johnson', '1988-07-22', 'female', 'O-', '', '', 'Dr. Martinez', 'Aetna', 'AE987654321', NULL, '(415) 555-0124', 'emma.johnson@email.com', ARRAY['Severe Allergies']::varchar[], ARRAY['Latex', 'Pollen']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4724', 'Margaret', 'Lee', '1991-10-05', 'female', 'A+', '', '', 'Dr. Jackson', 'Anthem', 'AN753159846', NULL, '(415) 555-0140', 'margaret.lee@email.com', ARRAY['Multiple Sclerosis']::varchar[], ARRAY['Penicillin', 'Sulfa Drugs']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4725', 'Daniel', 'Lewis', '1964-07-19', 'male', 'O-', '', '', 'Dr. Moore', 'Medicare', 'MC159357846', NULL, '(415) 555-0139', 'daniel.lewis@email.com', ARRAY['COPD', 'Emphysema']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4726', 'Jennifer', 'Martin', '1983-11-12', 'female', 'AB-', '', '', 'Dr. Brown', 'United Healthcare', 'UH951753684', NULL, '(415) 555-0132', 'jennifer.martin@email.com', ARRAY['Depression', 'Fibromyalgia']::varchar[], ARRAY['Peanuts']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4727', 'David', 'Miller', '1980-09-05', 'male', 'O+', '', '', 'Dr. Patel', 'Kaiser', 'KP159753468', NULL, '(415) 555-0127', 'david.miller@email.com', ARRAY['Type 2 Diabetes']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4728', 'John', 'Mitchell', '1988-07-22', 'male', 'A+', '183[cm]', '88[kg]', 'Dr. White', 'Medicare', 'MC789012345', NULL, '(415) 555-0133', 'john.mitchell@email.com', ARRAY['Sleep Apnea']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4729', 'Patricia', 'Moore', '1987-09-28', 'other', 'B+', '', '', 'Dr. Taylor', 'Aetna', 'AE753951852', NULL, '(415) 555-0134', 'patricia.moore@email.com', ARRAY['Rheumatoid Arthritis']::varchar[], ARRAY['Ibuprofen']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4730', 'Susan', 'Morgan', '1975-03-15', 'female', 'O-', '168[cm]', '63[kg]', 'Dr. Rodriguez', 'Blue Shield', 'BS678901234', NULL, '(415) 555-0132', 'susan.morgan@email.com', ARRAY['Hypothyroidism']::varchar[], ARRAY['Peanuts']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4731', 'Emma', 'Parker', '1962-11-30', 'female', 'AB+', '165[cm]', '62[kg]', 'Dr. Lee', 'Kaiser', 'KP456789012', NULL, '(415) 555-0128', 'emma.parker@email.com', ARRAY['Migraine']::varchar[], ARRAY['Shellfish']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4732', 'Michael', 'Roberts', '1975-03-15', 'male', 'O+', '182[cm]', '85[kg]', 'Dr. Brown', 'Cigna', 'CI234567890', NULL, '(415) 555-0129', 'michael.roberts@email.com', ARRAY['Type 2 Diabetes']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4733', 'Maria', 'Rodriguez', '1990-02-14', 'female', 'O+', '', '', 'Dr. Nguyen', 'Blue Shield', 'BS741852963', NULL, '(415) 555-0130', 'maria.rodriguez@email.com', ARRAY['Hypothyroidism']::varchar[], ARRAY['Sulfa Drugs']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4734', 'John', 'Smith', '1975-03-15', 'male', 'A+', '180[cm]', '75[kg]', 'Dr. Anderson', 'Blue Cross', 'BC123456789', NULL, '(415) 555-0123', 'john.smith@email.com', ARRAY['Hypertension', 'High Cholesterol']::varchar[], ARRAY['Penicillin']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4735', 'James', 'Taylor', '1958-06-25', 'male', 'B-', '', '', 'Dr. Lee', 'Humana', 'HU963852741', NULL, '(415) 555-0129', 'james.taylor@email.com', ARRAY['Coronary Artery Disease', 'Type 2 Diabetes']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4736', 'William', 'Thompson', '1967-04-03', 'male', 'O-', '', '', 'Dr. Garcia', 'Medicare', 'MC357159852', NULL, '(415) 555-0133', 'william.thompson@email.com', ARRAY['Osteoporosis']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4737', 'Joseph', 'Walker', '1969-05-12', 'male', 'B+', '', '', 'Dr. Harris', 'United Healthcare', 'UH357951846', NULL, '(415) 555-0141', 'joseph.walker@email.com', ARRAY['Parkinson''s Disease']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4738', 'Elizabeth', 'White', '1993-06-15', 'female', 'O+', '', '', 'Dr. Anderson', 'Kaiser', 'KP789456123', NULL, '(415) 555-0136', 'elizabeth.white@email.com', ARRAY['Celiac Disease']::varchar[], ARRAY['Dairy']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4739', 'Michael', 'Williams', '1962-11-30', 'male', 'B+', '', '', 'Dr. Chen', 'Medicare', 'MC456789123', NULL, '(415) 555-0125', 'michael.williams@email.com', ARRAY['Hypertension', 'Arthritis']::varchar[], ARRAY[]::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
...
INSERT INTO patients (
        ...
        insurance_provider, insurance_number, primary_address,
        phone, email, conditions, allergies
    ) VALUES ('4740', 'Barbara', 'Young', '1986-08-17', 'female', 'O+', '', '', 'Dr. Clark', 'Blue Shield', 'BS951357846', NULL, '(415) 555-0142', 'barbara.young@email.com', ARRAY['Lupus']::varchar[], ARRAY['Latex']::varchar[]);
INSERT INTO addresses (
            patient_id, address_type, address_line, street,
            city, state, zip_code, country
        ) VALUES (
